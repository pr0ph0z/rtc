<template>
  <div class="centered-container">
    <md-content class="md-elevation-5">
      ...
      <div class="actions m,d-layout md-alignment-center-space-between">
        <md-button class="md-raised md-primary" @click="loginAuth()">Register</md-button>
      </div>
      <span class="md-body-1">Already have an acoount? <router-link to="login">Login</router-link></span>
    </md-content>
